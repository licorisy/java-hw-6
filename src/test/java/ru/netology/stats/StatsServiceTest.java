...
public class StatsServiceTest {
    ...
    public void shouldFindSumAllMonth() {
        ...
        int expected = 180;
        long actual = service.getSum(sum);
    ...
    public void shouldFindMidSumAllMonth() {
        ...
        int expected = 15;
        long actual = service.midSum(sum);
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void shouldFindPickSalesMonth() {
        ...
        int expected = 7;
        long actual = service.pickSales(sum);
        Assertions.assertEquals(expected, actual);
    }
    ...
    public void shouldFindMinSalesMonth() {
        ...
        int expected = 8;
        long actual = service.minSales(sum);
        Assertions.assertEquals(expected, actual);
    }
    @Test
    public void shouldFindCountBelowAverageMonth() {
        ...
        int expected = 5;
        long actual = service.countBelowAverageMonth(sum);
        Assertions.assertEquals(expected, actual);
    }
    @Test
    public void shouldFindCountAboveAverageMonth() {
        ...
        int expected = 5;
        long actual = service.countAboveAverageMonth(sum);
        Assertions.assertEquals(expected, actual);
    }
